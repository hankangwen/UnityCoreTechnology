Shader "FastShadowReceiver/Projector/Multiply Lightmap Subtractive Shadow" {
	Properties {
	...
	Subshader {
		...
		Pass {
			...
			HLSLPROGRAM
			#pragma vertex fsr_vert_projector_diffuse_lightmap
			#pragma fragment fsr_frag_projector_shadow_alpha_falloff_lightmap_subtractive
