...
#if !defined(FAST_SHADOW_RECEIVER_ENABLECBUFFER_CGINC_DEFINED)
#define FAST_SHADOW_RECEIVER_ENABLECBUFFER_CGINC_DEFINED
...
#endif // !defined(FAST_SHADOW_RECEIVER_ENABLECBUFFER_CGINC_DEFINED)
