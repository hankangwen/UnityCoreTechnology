Shader "FastShadowReceiver/Projector/Multiply Lightmap Shadowmasked Shadow Without Falloff" {
	Properties {
	...
	Subshader {
		...
		Pass {
			...
			#pragma fragment fsr_frag_projector_shadow_alpha_nearclip_lightmap_shadowmask
